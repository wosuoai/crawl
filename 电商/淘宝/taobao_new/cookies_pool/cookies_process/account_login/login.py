...
class TBLogin(BaseLogin):
    ...
    def login(self,username:str,password:str)->dict:
        ...
        try:
            self.driver.get("https://item.taobao.com/item.htm?id=687674726313&spm=a1z10.3-c-s.w4002-23122658373.15.f673658dYDxNiu")
            WebDriverWait(self.driver, 30, 2).until(EC.presence_of_element_located((By.ID, 'J_Title')))
