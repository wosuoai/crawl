...
class SearchItemImg:
    def __init__(self, host=redisHost, port=redisPort, password=redisPassword):
        ...
        self.option.add_argument('--proxy-server=socks5://127.0.0.1:8888')
    ...
    def login_taobao(self,driver):
        ...
        name_input_element.send_keys("18072854747")

        time.sleep(2)
        password_input_element = driver.find_element(By.XPATH, '//*[@id="fm-login-password"]')
        time.sleep(1)
        password_input_element.clear()
        password_input_element.send_keys("dejavu888")
    ...
    # 通过requests返回每页搜索的信息
    def page_items(self, key_word: str, tbCookies: dict, startPage: int = 40, endPage: int = 100) -> list:
        ...
        for i in range(startPage, endPage):
            ...
            for url in comment_urls:
                ...
                elif "detail.tmall.hk" in url: #天猫国际的商品筛除掉
                    pass
                else:
...
if __name__ == "__main__":
    # 淘宝
    cookiesList = [{'l': 'fBT5QNx4PxgttdEEBOfwPurza77OSIRAguPzaNbMi9fP9G1J5P0RW1nRh5LvC3GVFsg9R3J_8YVHBeYBqSYDXGYme5DDwQHmnmOk-Wf..', 'tfstk': 'dJMkEM_wEbPWZY77tQeWU5GpXWdvFawQ82BLJJUegrzj29KS2jqEJqtBV8nU-20Yl0BpV0hcxcgm-Wt7JyznJDlJDdptV0wQLwY9BdIVvJwUH1rAg0i7dJSA8ChqV946jj6P7GBQyKDyq5UGAuL97oOa1Pozu0n-3ubT70zcL9zuqO7Rg1SVF9Z2vx5CO7rbmPFkD19f.', 'v': '0', 'uc1': 'cookie21=UIHiLt3xSalX&existShop=false&cookie16=WqG3DMC9UpAPBHGz5QBErFxlCA%3D%3D&pas=0&cookie14=Uoe9a7JfG4dBjA%3D%3D&cookie15=VT5L2FSpMGV7TQ%3D%3D', '_m_h5_tk_enc': '2a91cdfc11d1c9032a16a84f014fb175', '_m_h5_tk': '5b2422d490c5f34e4f705e494581893e_1696915081029', 'dnk': 'tb675900152750', 'cancelledSubSites': 'empty', 'cookie1': 'AHmARbUtDQf0ukZ86Lb%2B1T8d6lvSen3LOaBTFr0vJxE%3D', '_l_g_': 'Ug%3D%3D', 'cookie2': '17a49c39b5c2bf63e88302becaff21d2', 'uc4': 'id4=0%40U2gqz6QY%2BuLQ6lct5m54rey7kDu0f1tg&nk4=0%40FY4I6FUnZTj%2BCtAGblpRX8MTjiMGhZwrDg%3D%3D', '_nk_': 'tb675900152750', 'existShop': 'MTY5NjkwNDYzNw%3D%3D', 'csg': '8e97dad1', 'tracknick': 'tb675900152750', 'thw': 'cn', 'cna': 'nKOrHXzeuTACAX18ydw+Un2M', 'uc3': 'id2=UUpgQEvyiMFol7r9dg%3D%3D&nk2=F5RDK1aMEME8kyIMKUM%3D&lg2=W5iHLLyFOGW7aA%3D%3D&vt3=F8dCsGrMqHS2L5H4mX8%3D', 'unb': '2216208669787', 'mt': 'ci=0_1', 'sg': '070', 'lgc': 'tb675900152750', 'isg': 'BLi43jLXKT-bsEW7F4PVaRPKiWZKIRyr2iL0A_IpBPOmDVj3mjHsO86vwQW9XdSD', 'skt': '976354466fa6d46c', '_tb_token_': 'e88b73b45b037', 'sgcookie': 'E100AdB%2F3T7wj0dFTtziG7j5p5ZbUvekC6VaoSm6U%2BfTwwX1fPJpEe3IGK0F%2B5AoNKpwuhUdu3%2FhYs0%2BbupA0%2Fsq1RzkJ9gpQGar1KVbM66zpSA%3D', '_cc_': 'URm48syIZQ%3D%3D', 'cookie17': 'UUpgQEvyiMFol7r9dg%3D%3D', 'xlly_s': '1', 't': 'a6a75391cb63956b196a8e0eb842345f', '_samesite_flag_': 'true'}]
    # 天猫
    cookiesList1 = [{'v': '0', 'l': 'fB_sBzknPxgOxqz2mOfwPurza77OSIRAguPzaNbMi9fPOQ1M58wGW1nRnOYHC3GVFsM2R3J_8YVHBeYBqI2wsWRKe5DDwQHmnmOk-Wf..', 'tfstk': 'dMDJEF6jIEYkhzJzv6dD8a07t4xmwYnrD4o1Ky4lOq3xrcGuZDa3p23KJzVBz8DKk4msZ7mIKkMLUxclKzYzpDggpFYMIdmr47yBSFD6r0oPPhfccdvi40SuVhmXI3rA55BrbF_ybn6-evqWtkPU0FPqbuF8W94Ap9K327UsVrL65OJKIAENQN4Tx_tvD65UNoRJp3dO.', 'uc1': 'existShop=true&cookie21=WqG3DMC9Fbk9noNn0ySw&cookie16=WqG3DMC9UpAPBHGz5QBErFxlCA%3D%3D&cookie14=Uoe9a7JfG4j6BA%3D%3D&cookie15=V32FPkk%2Fw0dUvg%3D%3D&pas=0', '_m_h5_tk_enc': 'a22ad98e8c57e1388151277e45a2cf0b', '_m_h5_tk': '8634cca7b74e3e4e60001d24c9e14023_1696914326936', 'dnk': 't-3110751053-1', 'cancelledSubSites': 'empty', 'cookie1': 'Wqajzt427CkD7%2BKUaBPrkLCOKT2Ni0o1cMo4O%2B22aM4%3D', '_l_g_': 'Ug%3D%3D', 'cookie2': '15e68402a9625c6c0423b53f95df8ae5', 'uc4': 'id4=0%40UgbvDH8R6%2BaCqcdPWfZYlXJrwMCK&nk4=0%40FcEKYMKi8FTUUKLwv4FV6FiCntrap3QU5w%3D%3D', '_nk_': 't-3110751053-1', 'existShop': 'MTY5NjkwNDk2Mw%3D%3D', 'csg': '517f6bfb', 'tracknick': 't-3110751053-1', 'thw': 'cn', 'cna': '7aSrHcR5LRoCAX18ydxgiKZd', 'uc3': 'nk2=F9vlEhVtaAUXKX4c3Mk%3D&lg2=W5iHLLyFOGW7aA%3D%3D&id2=UNGXErL6DPTPew%3D%3D&vt3=F8dCsGrMqHS5%2B2oyOyI%3D', 'unb': '3110751053', 'mt': 'ci=7_1', 'sg': '134', 'lgc': 't-3110751053-1', 'isg': 'BJiYPtrNSV-5w2XbNJ9ahM24acYqgfwL-kLUo9KJ5FOGbThXepHMm65PoaXd_bTj', 'skt': 'ea63ed7d83ca6c46', '_tb_token_': '33eeee5e85e3b', 'sgcookie': 'E100WfzK3pKe2z7f1ZiRe0tPFFWnU3RrdFRXCJhHhHVYIVggMSKdvTX7HPiEZAqsi8FjgzyNHYYXrsw9JRcI8sAgEzQGPHZ2eznRSiO2lTJjcJA%3D', '_cc_': 'VFC%2FuZ9ajQ%3D%3D', 'cookie17': 'UNGXErL6DPTPew%3D%3D', 'xlly_s': '1', 't': '880b4f1afc1a9995151e636247e24f90', '_samesite_flag_': 'true'}]
