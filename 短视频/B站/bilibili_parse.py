...
class BlibiliParse(object):
    def __init__(self, bv: str, thread_nums: int = 5) -> None:
        self.bv = bv    # 视频bv号
        self.video_url = None   # 视频链接
        self.audio_url = None   # 音频链接
        self.cookie = None  # cookies
        self.console = Console()    # 高亮部分
        self.thread_nums = thread_nums  # 线程数

        # 检测是否有cookies的值，如果有赋值给self.cookie
        ...
        self.bv_name = None     # 视频的标题
        self.output_path = 'video'  # 视频保存路径
